...
class TestDeviceProfiles(unittest.TestCase):
    ...
    def test_device_profiler_import(self):
        ...
        from forge_ai.core.device_profiles import (
            DeviceProfiler,
            DeviceClass,
            DeviceCapabilities,
            ProfileSettings,
    ...
    def test_device_profiler_singleton(self):
        ...
        from forge_ai.core.device_profiles import get_device_profiler
    ...
    def test_classify_device(self):
        """Can classify device."""
        from forge_ai.core.device_profiles import get_device_profiler, DeviceClass
        profiler = get_device_profiler()
    ...
    def test_get_optimal_settings(self):
        ...
        from forge_ai.core.device_profiles import get_optimal_settings
    ...
    def test_recommended_model_size(self):
        ...
        from forge_ai.core.device_profiles import get_recommended_model_size
...
class TestPowerMode(unittest.TestCase):
    ...
    def test_power_mode_import(self):
        ...
        from forge_ai.core.power_mode import (
            PowerLevel,
            PowerManager,
            get_power_manager,
        )
    ...
    def test_embedded_level_exists(self):
        ...
        from forge_ai.core.power_mode import PowerLevel
    ...
    def test_power_manager_singleton(self):
        ...
        from forge_ai.core.power_mode import get_power_manager
    ...
    def test_auto_power_mode(self):
        ...
        from forge_ai.core.power_mode import auto_power_mode
        pm = auto_power_mode()
...
class TestLowPowerInference(unittest.TestCase):
    ...
    def test_low_power_import(self):
        ...
        from forge_ai.core.low_power_inference import (
            LowPowerConfig,
            LowPowerEngine,
            get_engine,
        )
    ...
    def test_config_for_raspberry_pi(self):
        ...
        from forge_ai.core.low_power_inference import LowPowerConfig
...
class TestQuantization(unittest.TestCase):
    ...
    def test_quant_config_for_device(self):
        ...
        from forge_ai.core.quantization import QuantConfig
    ...
    def test_quantized_linear_creation(self):
        ...
        from forge_ai.core.quantization import QuantizedLinear
    ...
    def test_estimate_model_size(self):
        ...
        import torch.nn as nn
        from forge_ai.core.quantization import estimate_model_size
...
class TestDistributedProtocol(unittest.TestCase):
    ...
    def test_distributed_import(self):
        ...
        from forge_ai.comms.distributed import (
            DistributedNode,
            NodeRole,
            MessageType,
            ProtocolMessage,
...
class TestUnifiedPatterns(unittest.TestCase):
    ...
    def test_style_config_singleton(self):
        ...
        try:
            from forge_ai.gui.tabs.unified_patterns import get_style_config
            s1 = get_style_config()
            s2 = get_style_config()
            self.assertIs(s1, s2)
        except ImportError:
    ...
    def test_colors_defined(self):
        """Colors are defined."""
        try:
            from forge_ai.gui.tabs.unified_patterns import Colors
    ...
    def test_button_styles(self):
        ...
        try:
            from forge_ai.gui.tabs.unified_patterns import get_button_style
