...
def test_cloud_modules_marked():
    ...
    for module_id in cloud_module_ids:
        ...
        print(f"  ✓ {module_id} correctly marked as cloud service")
...
def test_local_modules_marked():
    ...
    print(f"  ✓ All {len(local_module_ids)} local modules marked correctly!\n")
...
def test_local_only_default_true():
    ...
    try:
        ...
        assert manager.local_only is True, \
            "ModuleManager should default to local_only=True"
        print("  ✓ local_only defaults to True!\n")
...
def test_local_only_prevents_cloud_loading():
    ...
    try:
        ...
        for module_id in cloud_modules:
            ...
            print(f"  ✓ {module_id} blocked in local_only mode")
...
def test_local_only_false_allows_cloud():
    ...
    try:
        ...
        for module_id in cloud_modules:
            ...
            print(f"  ✓ {module_id} passes cloud check")
...
def test_list_local_modules():
    ...
    print(f"  ✓ Found {len(local_modules)} local modules")
...
def test_list_cloud_modules():
    ...
    print(f"  ✓ Found {len(cloud_modules)} cloud modules")
...
def test_all_modules_categorized():
    ...
    print(f"  ✓ Local: {len(local_modules)} modules")
    print(f"  ✓ Cloud: {len(cloud_modules)} modules")
...
def test_module_info_field():
    ...
    print("  ✓ Field exists and defaults to False")
    ...
    print("  ✓ Field can be set to True\n")
