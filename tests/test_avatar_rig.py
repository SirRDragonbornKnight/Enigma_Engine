...
The bone-identification logic lives in JavaScript because it operates on three.js
skeletons, so the real assertions are in ``mods/avatar/tests/*.test.js``. This wrapper
