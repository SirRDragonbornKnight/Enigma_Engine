"""
Tests for enigma_engine/utils/security.py
...
class TestPathBlocking:
    ...
    def test_blocked_patterns_reject_sensitive_files(self):
        ...
        from enigma_engine.utils.security import is_path_blocked
    ...
    def test_get_blocked_paths_returns_list(self):
        ...
        from enigma_engine.utils.security import get_blocked_paths
    ...
    def test_get_blocked_patterns_returns_list(self):
        ...
        from enigma_engine.utils.security import get_blocked_patterns
...
class TestSecurityInitialization:
    ...
    def test_security_module_imports(self):
        ...
        from enigma_engine.utils import security
    ...
    def test_initialization_is_idempotent(self):
        ...
        from enigma_engine.utils.security import _initialize_blocks
...
class TestAddBlockedPath:
    ...
    def test_add_blocked_path_exists(self):
        ...
        from enigma_engine.utils.security import add_blocked_path
        assert callable(add_blocked_path)
    
    def test_add_blocked_pattern_exists(self):
        """Test that add_blocked_pattern function exists."""
        from enigma_engine.utils.security import add_blocked_pattern
