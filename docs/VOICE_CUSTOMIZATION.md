...
# Use the voice
from enigma.voice.voice_profile import VoiceEngine
engine = VoiceEngine()
...
```python
from enigma.voice.voice_generator import create_voice_from_samples
...
```python
from enigma.voice.voice_profile import speak, set_voice
