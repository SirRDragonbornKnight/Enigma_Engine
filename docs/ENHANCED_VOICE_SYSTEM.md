...
from enigma_engine.voice import set_voice, speak
...
```python
from enigma_engine.voice.voice_identity import AIVoiceIdentity
...
```python
from enigma_engine.voice import describe_voice, speak
...
```python
from enigma_engine.voice import apply_effect, apply_effects
...
```python
from enigma_engine.voice.voice_effects import VoiceEffects
...
```python
from enigma_engine.voice import adapt_voice_for_emotion, VoiceProfile
...
```python
from enigma_engine.voice import adapt_voice_for_context
...
```python
from enigma_engine.voice import adapt_voice_for_personality
from enigma_engine.core.personality import load_personality
...
```python
from enigma_engine.voice.trigger_phrases import SmartWakeWords
...
```python
from enigma_engine.voice import train_custom_wake_phrase
...
```python
from enigma_engine.voice import create_voice_from_samples
...
```python
from enigma_engine.voice import analyze_audio
...
```python
from enigma_engine.voice import compare_voice_audio
...
```python
from enigma_engine.voice import interactive_tuning
...
```python
from enigma_engine.voice import import_voice_profile, export_voice_profile, VoiceProfile
...
```python
from enigma_engine.voice import compare_voices
from enigma_engine.voice import PRESET_PROFILES
...
```python
from enigma_engine.voice import adjust_voice_from_feedback
...
```python
from enigma_engine.voice import effect_for_emotion, effect_for_context
...
```python
from enigma_engine.voice import *
from enigma_engine.core.personality import load_personality
...
- `enigma_engine.voice.voice_identity` - AI voice discovery
- `enigma_engine.voice.voice_effects` - Effects system
- `enigma_engine.voice.dynamic_adapter` - Voice adaptation
- `enigma_engine.voice.voice_customizer` - User tools
- `enigma_engine.voice.audio_analyzer` - Audio analysis
- `enigma_engine.voice.trigger_phrases` - Wake words
