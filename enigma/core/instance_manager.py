"""
Multi-Instance Manager for Enigma

Manages multiple Enigma instances running simultaneously.
...
class InstanceManager:
    """
    Manage multiple Enigma instances.
    ...
    def list_running_instances(self) -> List[Dict[str, Any]]:
        """
        List all running Enigma instances.
...
def get_active_instances() -> List[Dict[str, Any]]:
    """Get list of all active Enigma instances."""
    manager = InstanceManager()
