"""
Examples Tab for Enigma Engine GUI
==================================
...
EXAMPLES = {
    "basic_usage.py": {
        "title": "Basic Usage",
        "description": "The simplest way to use Enigma for text generation. Shows basic prompts and temperature settings.",
    ...
    "multi_device_example.py": {
        "title": "Multi-Device",
        "description": "Run Enigma across multiple devices (Pi + PC). Includes server/client modes.",
        "category": "Networking"
    },
