...
Features:
  ...
  - Connect to remote Enigma instances
...
class NetworkScanner(QThread):
    ...
    def run(self):
        """Scan local network for Enigma instances."""
        devices = []
...
class NetworkTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        desc = QLabel("Connect multiple Enigma instances, share models, and manage remote devices.")
    ...
    def _scan_network(self):
        """Scan network for Enigma instances."""
        ...
        self._log("Scanning network for Enigma instances...")
    ...
    def _connect_to_remote(self):
        """Connect to a remote Enigma instance."""
        ...
        try:
            ...
            req.add_header('User-Agent', 'Enigma-Client/1.0')
