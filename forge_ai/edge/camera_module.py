...
Integrates with ForgeAI vision for image analysis.

FILE: forge_ai/edge/camera_module.py
TYPE: Edge
...
def analyze_image_with_forge(camera: CameraModule, prompt: str = "Describe this image") -> Optional[str]:
    ...
    try:
        from forge_ai.tools.vision_tools import analyze_image
