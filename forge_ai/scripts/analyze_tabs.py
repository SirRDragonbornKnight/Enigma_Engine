...
USAGE:
    python -m forge_ai.scripts.analyze_tabs
    
    # Or programmatically:
    from forge_ai.scripts.analyze_tabs import TabAnalyzer
...
def main():
    ...
    print("ForgeAI Tab Consistency Analyzer")
    print("-" * 40)
