...
Handles schema changes and migrations between ForgeAI versions.
Automatically updates user configurations when upgrading.

Usage:
    from forge_ai.config.migration import ConfigMigrator, migrate_config
...
class ConfigMigrator:
    """
    Handles configuration migration between ForgeAI versions.
