...
class SetupWizard(QWizard):
    ...
    def _create_welcome_page(self):
        page = QWizardPage()
        page.setTitle("Welcome to ForgeAI")
...
class EnhancedMainWindow(QMainWindow):
    ...
    def _show_model_selector_deferred(self):
        ...
        self.setWindowTitle(f"ForgeAI - Loading {self.current_model_name}...")
    ...
    def _load_current_model(self):
        ...
        try:
            ...
            self.setWindowTitle(f"ForgeAI - {self.current_model_name} {model_type}")
...
Be friendly, concise, and proactive in helping users accomplish their goals."""
    ...
    def _auto_control_from_response(self, response: str):
        ...
        if robot_auto_enabled and robot_module_loaded:
            ...
            if robot_command:
                try:
                    from forge_ai.tools.robot_tools import get_robot
                    robot = get_robot()
    ...
    def _on_open_model(self):
        ...
        if dialog.exec_() == QDialog.Accepted:
            ...
            if selected:
                ...
                self._load_current_model()
                self.model_status_btn.setText(f"Model: {self.current_model_name}  v")
                self.setWindowTitle(f"ForgeAI - {self.current_model_name}")
