...
Browse, search, and install community plugins for ForgeAI.
Displays available plugins from a registry with ratings, descriptions,
and one-click installation.

Usage:
    from forge_ai.gui.tabs.marketplace_tab import MarketplaceTab
...
class MarketplaceTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        subtitle = QLabel("Browse and install community plugins to extend ForgeAI")
