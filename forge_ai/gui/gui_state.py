...
📍 FILE: forge_ai/gui/gui_state.py
...
🔗 CONNECTED FILES:
    ...
    → USES:      forge_ai/config/defaults.py (CONFIG)
    ← USED BY:   forge_ai/tools/tool_executor.py (AI tool execution)
    ← USED BY:   forge_ai/gui/enhanced_window.py (window registration)
    ...
    def _init_help_topics(self) -> dict[str, HelpTopic]:
        ...
        return {
            "getting_started": HelpTopic(
                ...
                content="""Welcome to ForgeAI! Here's how to get started:
...
- Customize appearance in settings""",
            ...
            "modules": HelpTopic(
                title="Module System",
                content="""ForgeAI is fully modular - load only what you need!
...
- Output: Voice, avatar""",
            ...
            "settings": HelpTopic(
                ...
                content="""Customize ForgeAI to your preferences!
...
- Ctrl+C: Copy selected text""",
            ...
            "tips": HelpTopic(
                title="Tips & Tricks",
                content="""Get the most out of ForgeAI!
