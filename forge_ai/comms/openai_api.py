...
(LangChain, LlamaIndex, AutoGPT, etc.) works with Forge_AI.

📍 FILE: forge_ai/comms/openai_api.py
...
USAGE:
    # Start server
    python -m forge_ai.comms.openai_api
...
class OpenAICompatibleServer:
    ...
    tool or library can use Forge_AI as a drop-in replacement.
    """
    ...
    def _setup_routes(self):
        ...
        def root():
            ...
            return jsonify({
                "name": "Forge_AI OpenAI-Compatible API",
                "version": "1.0.0",
                "endpoints": {
    ...
    def run(self, debug: bool = False):
        """Start the server."""
        print(f"\n{'='*60}")
        print("  Forge_AI OpenAI-Compatible API Server")
        print(f"{'='*60}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Forge_AI OpenAI-Compatible API")
