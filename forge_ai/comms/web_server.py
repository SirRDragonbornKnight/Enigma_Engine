...
<body>
    <div class="container">
        ...
        <div class="chat-container" id="chatContainer">
            <div class="message system">Welcome to ForgeAI. Type a message to begin.</div>
        </div>
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='ForgeAI Web Server')
