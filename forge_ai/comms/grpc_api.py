...
High-performance RPC interface for ForgeAI.

FILE: forge_ai/comms/grpc_api.py
TYPE: API
...
def save_proto_file(output_path: str = "forge_ai/comms/forge.proto"):
