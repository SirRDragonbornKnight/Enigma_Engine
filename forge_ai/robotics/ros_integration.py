...
Robot Operating System integration for ForgeAI.
Enables AI-controlled robots with ROS1 and ROS2 support.

FILE: forge_ai/robotics/ros_integration.py
TYPE: Robotics
...
class ROSNode:
    """
    High-level ROS node interface for ForgeAI.
    """
