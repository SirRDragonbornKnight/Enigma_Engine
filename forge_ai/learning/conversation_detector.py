...
📍 FILE: forge_ai/learning/conversation_detector.py
🏷️ TYPE: Learning Detection System
🎯 MAIN CLASS: ConversationDetector, DetectedLearning

INTEGRATES WITH:
    → forge_ai/core/self_improvement.py (LearningEngine, LearningExample)
    → forge_ai/core/autonomous.py (AutonomousLearner background processing)
