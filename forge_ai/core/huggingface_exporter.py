...
Export ForgeAI-trained models to HuggingFace Hub format.
...
class HuggingFaceExporter:
    """
    Export ForgeAI models to HuggingFace format.
    ...
    def __init__(self, models_dir: Optional[str] = None):
        ...
        Args:
            models_dir: Path to ForgeAI models directory (default: CONFIG["models_dir"])
        """
    ...
    def _convert_config_to_hf(self, forge_config: Dict[str, Any], metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        hf_config = {
            # Model architecture (custom ForgeAI type)
            "model_type": "forge",
            ...
            # ForgeAI specific (for round-trip loading)
    ...
    def export_to_hf_format(
        ...
        Args:
            model_name: Name of the model in ForgeAI registry
...
This model was trained using [ForgeAI](https://github.com/forgeai/forge-ai), a modular AI framework.
...
# Use _forge_config for exact ForgeAI settings
forge_config = config.get("_forge_config", {{}})
```

## Training

This model was trained on custom data using the ForgeAI training pipeline.
...
"""
    ...
    def push_to_hub(
        ...
        private: bool = False,
        commit_message: str = "Upload ForgeAI model",
        include_tokenizer: bool = True
    ) -> str:
        """
        Push a ForgeAI model directly to HuggingFace Hub.
...
def export_model_to_hub(
    ...
    Args:
        model_name: Name of the ForgeAI model
