...
CAPABILITIES = {
    ...
    "voice_output": {
        ...
        "forge_tool": "audio",
        "note": "Built into ForgeAI! Enable in settings or click voice button.",
    ...
    "voice_input": {
        ...
        "forge_tool": None,
        "note": "Built into ForgeAI! Click the REC button in chat.",
        "no_model_needed": True
    },
    "image_generation": {
    ...
    return {
        ...
        "weird_issues": [
            ...
            },
            {
                ...
                "cause": "By design - HF models are read-only in ForgeAI",
