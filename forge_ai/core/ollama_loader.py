...
Load and convert models from Ollama format to ForgeAI.

FILE: forge_ai/core/ollama_loader.py
TYPE: Model Loading
...
class OllamaModelLoader:
    ...
    def load_model(
        ...
        """
        Load Ollama model into ForgeAI format.
    ...
    def convert_to_forge(
        ...
        """
        Convert Ollama model to ForgeAI format.
        
        Args:
            model_name: Ollama model name
            output_path: Output path for ForgeAI model
