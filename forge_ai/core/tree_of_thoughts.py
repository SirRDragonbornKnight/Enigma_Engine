...
FILE: forge_ai/core/tree_of_thoughts.py
...
# Integration with ForgeAI inference
class ForgeToTIntegration:
    """Integration layer for using ToT with ForgeAI inference."""
    ...
    def _create_generator(self):
        """Create thought generator using ForgeAI."""
    ...
    def _create_evaluator(self):
        """Create thought evaluator using ForgeAI."""
