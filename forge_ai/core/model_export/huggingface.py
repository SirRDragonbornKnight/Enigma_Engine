...
class HuggingFaceProvider(ExportProvider):
    ...
    Your ForgeAI models can be shared and discovered by the community.
...
Trained with [ForgeAI](https://github.com/forgeai/forge-ai).
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                api.upload_folder(
                    ...
                    repo_id=repo_id,
                    token=token,
                    commit_message=f"Upload ForgeAI model {model_name}"
                )
