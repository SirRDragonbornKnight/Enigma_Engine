...
Provides a unified interface to use ForgeAI's tools and capabilities
...
FILE: forge_ai/core/standalone_tools.py
...
def use_tool(
    ...
    **kwargs,
    ...
    """
    Use a ForgeAI tool standalone (without LLM/chat).
