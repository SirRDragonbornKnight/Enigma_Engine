"""
================================================================================
Gaming Mode - Run ForgeAI alongside games without performance impact.
================================================================================

This module provides intelligent resource management that allows ForgeAI to
...
USAGE:
    from forge_ai.core.gaming_mode import GamingMode, get_gaming_mode
...
class GamingMode:
    ...
    def save_profiles(self, path: Path = None):
        ...
        if path is None:
            ...
            path = CONFIG.DATA_DIR / "gaming_profiles.json"
