...
📍 FILE: forge_ai/core/hardware_detection.py
...
🔗 CONNECTED FILES:
    ...
    ← USED BY:   forge_ai/core/model.py (auto_configure)
    ← USED BY:   forge_ai/core/inference.py (ForgeEngine)
...
📖 SEE ALSO:
    • forge_ai/core/model.py          - Model creation with presets
    • forge_ai/core/hardware.py       - Legacy hardware detection
