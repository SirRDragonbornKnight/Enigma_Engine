...
FILE: forge_ai/testing/benchmarks.py
TYPE: Testing
...
class BenchmarkSuite:
    """
    Collection of benchmarks for ForgeAI components.
    """
...
# Built-in benchmarks for ForgeAI
def create_forgeai_benchmarks() -> BenchmarkSuite:
    """Create benchmark suite for ForgeAI components."""
...
def run_benchmarks():
    """Run all ForgeAI benchmarks."""
    suite = create_forgeai_benchmarks()
