...
📍 FILE: forge_ai/memory/conversation_summary.py
...
🔗 CONNECTED FILES:
    → USES:      forge_ai/core/inference.py (for AI-powered summarization)
    → USES:      forge_ai/memory/manager.py (conversation storage)
    ← USED BY:   forge_ai/gui/tabs/chat_tab.py (summary button)
    ← USED BY:   forge_ai/core/tool_router.py (context for routing)
