# ForgeAI Web Interface

Self-hosted web interface for accessing ForgeAI from any device on your local network.
...
python -c "from forge_ai.web.server import create_web_server; create_web_server().start()"
```
...
4. Phone opens ForgeAI automatically
...
### Install as App (PWA)
1. Open ForgeAI in phone browser
2. Use browser's "Add to Home Screen" option
3. ForgeAI appears as an app icon
4. Works offline with cached content

## Local Network Discovery

The server advertises itself via mDNS/Bonjour as "ForgeAI on [ComputerName]".

On supported devices, ForgeAI will appear in:
- Network browser
