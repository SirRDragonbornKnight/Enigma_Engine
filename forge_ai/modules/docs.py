"""
ForgeAI Module Documentation Generator
====================================
...
class ModuleDocGenerator:
    ...
    def generate_markdown(self, module_id: str) -> str:
        ...
        lines.append("")
        lines.append("```python")
        lines.append("from forge_ai.modules import ModuleManager")
        lines.append("")
    ...
    def generate_all_markdown(self) -> str:
        ...
        # Header
        lines.append("# ForgeAI - Module Documentation")
        lines.append("")
    ...
    def export_to_file(self, path: Path, format: str = 'markdown'):
        ...
        if format == 'markdown':
            ...
            content += '<h1>ForgeAI - All Modules</h1>'
            for module_id in sorted(self.manager.module_classes.keys()):
