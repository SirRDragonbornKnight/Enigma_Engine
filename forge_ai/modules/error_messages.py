...
Usage:
    from forge_ai.modules.error_messages import get_friendly_error
...
ERROR_PATTERNS: dict[str, ErrorInfo] = {
    "not registered": ErrorInfo(
        ...
        suggestion="Check the module name or try reinstalling ForgeAI.",
        severity="error"
    ),
...
def get_friendly_error(module_id: str, technical_reason: str) -> ErrorInfo:
    ...
    return ErrorInfo(
        ...
        suggestion="Check the logs for more details or try restarting ForgeAI.",
        severity="error"
    )
