...
Helm chart templates for deploying ForgeAI on Kubernetes.
Includes deployment, service, configmap, and autoscaling.

FILE: forge_ai/deploy/helm/values.yaml (conceptual)
...
class HelmChartGenerator:
    ...
    def _write_chart_yaml(self, chart_dir: Path):
        ...
        chart = {
            ...
            "description": "ForgeAI - Modular AI Framework",
            "type": "application",
            "version": "0.1.0",
            "appVersion": "1.0.0",
            ...
            "maintainers": [
                {"name": "ForgeAI Team", "email": "team@forge-ai.dev"}
            ]
        }
...
'''
    ...
    def _write_notes(self, templates_dir: Path):
        ...
        notes = '''ForgeAI has been deployed!
...
def generate_helm_chart(output_dir: Path, config: HelmChartConfig = None):
    """
    Generate a Helm chart for ForgeAI.
