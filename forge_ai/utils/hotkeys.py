...
Usage:
    from forge_ai.utils.hotkeys import HotkeyManager, get_hotkey_manager
...
# Default hotkey definitions for ForgeAI
DEFAULT_HOTKEYS = {
    "toggle_ai": {
        "keys": "ctrl+shift+a",
...
def setup_default_hotkeys(callbacks: Optional[Dict[str, Callable]] = None):
    """
    Set up default ForgeAI hotkeys.
