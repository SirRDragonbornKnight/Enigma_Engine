...
A centralized event bus that enables loose coupling between ForgeAI modules.
...
FILE: forge_ai/utils/events.py
TYPE: System Utility
MAIN CLASSES: EventBus, Event

USAGE:
    from forge_ai.utils.events import get_event_bus, Event, on_event
...
# =============================================================================
# Integration with ForgeAI components
# =============================================================================

def _register_builtin_publishers():
    """Hook into ForgeAI components to auto-publish events."""
    bus = get_event_bus()
    ...
    logger.debug("Event bus ready for ForgeAI component integration")
