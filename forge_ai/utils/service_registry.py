    ...
    def _check_service_health(self, name: str, service: Service) -> None:
        ...
        try:
            ...
            request = urllib.request.Request(
                ...
                method='GET',
                headers={'User-Agent': 'ForgeAI-HealthCheck/1.0'}
            )
...
# Pre-configured service types for ForgeAI
class ForgeServices:
    """Pre-defined service names for ForgeAI."""
