...
In the grand halls of ForgeAI, the Herald stands ready to announce all
...
FILE: forge_ai/utils/system_messages.py
...
USAGE:
    from forge_ai.utils.system_messages import system_msg, ai_msg, error_msg
...
CONNECTED REALMS:
    USED BY:   forge_ai/core/training.py - Training progress messages
    USED BY:   forge_ai/core/inference.py - Generation status
    USED BY:   forge_ai/gui/ - User interface messages
"""
...
def system_msg(text: str) -> str:
    ...
    Used for messages from ForgeAI's core systems - initialization,
...
def forge_msg(text: str) -> str:
    ...
    the ForgeAI identity. Use this for new code.
    """
    return f"{MessagePrefix.AI} {text}"
