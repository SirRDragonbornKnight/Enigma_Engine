...
Usage:
    from forge_ai.utils.api_keys import APIKeyManager, get_key_manager
...
DEFAULT_KEY_PATH = Path.home() / ".forge_ai" / "keys.enc"
SALT_PATH = Path.home() / ".forge_ai" / ".salt"
...
class APIKeyManager:
    ...
    def _get_machine_id(self) -> str:
        ...
        combined = f"{node}-{system}-{machine}-forgeai"
