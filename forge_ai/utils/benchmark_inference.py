...
Usage:
    # From command line
    python -m forge_ai.utils.benchmark_inference
    
    # From code
    from forge_ai.utils.benchmark_inference import run_benchmark, quick_benchmark
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Benchmark ForgeAI inference")
    parser.add_argument(
        '--sizes', 
        nargs='+', 
