...
Self-updating mechanism for ForgeAI with rollback support.
Supports GitHub releases, custom update servers, and delta updates.

FILE: forge_ai/utils/auto_update.py
TYPE: System/Updates
...
class UpdateConfig:
    ...
    # Update sources
    github_repo: str = "forgeai/forge_ai"
    ...
    def __post_init__(self):
        ...
        if self.temp_dir is None:
            self.temp_dir = Path(tempfile.gettempdir()) / "forgeai_updates"
...
class UpdateChecker:
    ...
    def _get_current_version(self) -> Version:
        ...
        try:
            ...
            # Try __init__.py
            init_file = self.config.install_dir / "forge_ai" / "__init__.py"
            if init_file.exists():
