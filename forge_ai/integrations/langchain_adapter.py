...
Adapters for using ForgeAI with LangChain framework.
Provides LLM, Chat Model, and Embeddings implementations.

FILE: forge_ai/integrations/langchain_adapter.py
TYPE: Integration
...
if HAS_LANGCHAIN:
    ...
    class ForgeLLM(LLM):
        """
        LangChain LLM wrapper for ForgeAI.
        
        Example:
            ```python
            from forge_ai.integrations.langchain_adapter import ForgeLLM
    ...
    class ForgeChatModel(BaseChatModel):
        """
        LangChain Chat Model wrapper for ForgeAI.
        
        Example:
            ```python
            from forge_ai.integrations.langchain_adapter import ForgeChatModel
    ...
    class ForgeEmbeddings(Embeddings):
        """
        LangChain Embeddings wrapper for ForgeAI.
        
        Example:
            ```python
            from forge_ai.integrations.langchain_adapter import ForgeEmbeddings
