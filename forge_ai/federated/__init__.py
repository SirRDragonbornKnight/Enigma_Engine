...
FILE: forge_ai/federated/__init__.py
...
USAGE:
    ...
    from forge_ai.federated import FederatedLearning, FederationMode
...
SEE ALSO:
    • forge_ai/federated/federation.py - Core classes
    • forge_ai/federated/aggregation.py - Update aggregation
    • forge_ai/federated/privacy.py - Privacy protection
