...
from enigma_engine.gui.tabs.settings_tab import create_settings_tab
print(f'GUI Tabs: chat, training, settings all have create functions')

# 10. Avatar system
from enigma_engine.gui.tabs.avatar.avatar_display import create_avatar_subtab, AvatarOverlayWindow
