...
class Router:
            ...
            while self._running:
                try:
                    ...
                    if msg.type == MessageType.REGISTER:
                        ...
                        resp = Message(
                            type=MessageType.RESPONSE,
                            payload=self._get_services_info(),
                            id=msg.id
                        )
    ...
    def _register_service(self, payload: Dict[str, Any], conn: socket.socket, 
                         addr: tuple) -> Optional[str]:
    ...
    def _send_to_service(self, service_name: str, command: str, 
...
class RouterClient:
    ...
    def send_command(self, service: str, command: str, 
    ...
    def route_by_capability(self, capability: str, command: str,
                           params: Optional[Dict] = None) -> Dict[str, Any]:
