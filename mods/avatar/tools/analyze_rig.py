...
# position, and the direction it points (parent→child). So gestures pose the RIGHT bones on the RIGHT
# axes instead of guessing. Usage: python analyze_rig.py <model.glb>
