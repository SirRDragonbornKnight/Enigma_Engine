...
def _parse(argv: list[str]) -> dict | None:
    ...
    if head == "fingers":                                # curl a hand 0..1, or `none` to release to the reactive grip: `fingers R 1` / `fingers L none`
...
DEMO_SEQUENCE = [
    ...
    (0.4, {"action": "pose", "flex": {"right_arm": [1.1], "right_forearm": [0.5]}, "dur": 4.5, "id": "demo"}),   # raise the right hand (self-expires)
