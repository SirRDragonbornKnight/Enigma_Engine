...
📍 FILE: enigma_engine/comms/ai_collaboration.py
...
🔗 CONNECTED FILES:
    → USES:      enigma_engine/comms/network.py (ForgeNode for connectivity)
    → USES:      enigma_engine/core/tool_router.py (tool execution)
    ← USED BY:   enigma_engine/core/tool_router.py (smart routing)
...
📖 SEE ALSO:
    • enigma_engine/comms/network.py       - Network connectivity
    • enigma_engine/core/tool_router.py    - Tool routing
...
class AICollaborationProtocol:
    ...
    📖 WHAT THIS DOES:
    Manages communication between multiple Enigma AI Engine instances to:
