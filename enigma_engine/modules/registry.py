...
📍 FILE: enigma_engine/modules/registry.py
...
│                                                                             │
│  🧠 CORE:                                                                    │
│     • ModelModule       - Forge transformer (enigma_engine/core/model.py)       │
│     • TokenizerModule   - Text tokenizer (enigma_engine/core/tokenizer.py)      │
│     • InferenceModule   - Text generation (enigma_engine/core/inference.py)     │
│                                                                             │
...
🔗 CONNECTED FILES:
    → USES:      enigma_engine/modules/manager.py (Module base class)
    → WRAPS:     enigma_engine/core/*.py (core modules)
    → WRAPS:     enigma_engine/gui/tabs/*.py (generation tabs)
    ← USED BY:   enigma_engine/modules/manager.py (discovers modules)

📖 SEE ALSO:
    • enigma_engine/modules/manager.py       - Loads/unloads modules
    • enigma_engine/gui/tabs/modules_tab.py  - GUI for toggling
...
class ModelModule(Module):
    ...
    🔗 WRAPS: enigma_engine/core/model.py → Forge class
    """
...
class TokenizerModule(Module):
    ...
    🔗 WRAPS: enigma_engine/core/tokenizer.py
    """
...
class TrainingModule(Module):
    ...
    🔗 WRAPS: enigma_engine/core/training.py → Trainer class
    """
...
class GGUFLoaderModule(Module):
    ...
    🔗 WRAPS: enigma_engine/core/gguf_loader.py → GGUFModel class
    """
...
class MemoryModule(Module):
    ...
    🔗 WRAPS: enigma_engine/memory/manager.py → ConversationManager class
    """
...
class VoiceInputModule(Module):
    ...
    🔗 WRAPS: enigma_engine/voice/stt_simple.py
    """
...
class VisionModule(Module):
    ...
    🔗 WRAPS: enigma_engine/tools/vision.py → ScreenVision class
    """
...
class AvatarModule(Module):
    ...
    🔗 WRAPS: enigma_engine/avatar/controller.py → AvatarController class
    """
...
class WebToolsModule(Module):
    ...
    🔗 WRAPS: enigma_engine/tools/web_tools.py → WebTools class
    """
...
class FileToolsModule(Module):
    ...
    🔗 WRAPS: enigma_engine/tools/file_tools.py
    """
...
class ToolRouterModule(Module):
    ...
    🔗 WRAPS: enigma_engine/core/tool_router.py → ToolRouter class
    """
...
class APIServerModule(Module):
    ...
    🔗 WRAPS: enigma_engine/comms/api_server.py → create_app()
    """
...
class NetworkModule(Module):
    ...
    🔗 WRAPS: enigma_engine/comms/network.py → ForgeNode class
    """
...
class TunnelModule(Module):
    ...
    🔗 WRAPS: enigma_engine/comms/tunnel_manager.py → TunnelManager class
    """
...
class GUIModule(Module):
    ...
    🔗 WRAPS: enigma_engine/gui/enhanced_window.py → EnhancedMainWindow
    """
...
class ImageGenLocalModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/image_tab.py → StableDiffusionLocal
    """
...
class ImageGenAPIModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/image_tab.py → OpenAIImage, ReplicateImage
    """
...
class CodeGenLocalModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/code_tab.py → ForgeCode
    """
...
class CodeGenAPIModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/code_tab.py → OpenAICode
    """
...
class VideoGenLocalModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/video_tab.py → LocalVideo
    """
...
class VideoGenAPIModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/video_tab.py → ReplicateVideo
    """
...
class AudioGenLocalModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/audio_tab.py → LocalTTS
    """
...
class AudioGenAPIModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/audio_tab.py → ElevenLabsTTS, ReplicateAudio
    """
...
class EmbeddingLocalModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/embeddings_tab.py → LocalEmbedding
    """
...
class EmbeddingAPIModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/embeddings_tab.py → OpenAIEmbedding
    """
...
class ThreeDGenLocalModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/threed_tab.py → Local3DGen
    """
...
class ThreeDGenAPIModule(GenerationModule):
    ...
    🔗 WRAPS: enigma_engine/gui/tabs/threed_tab.py → Cloud3DGen
    """
...
class MotionTrackingModule(Module):
    ...
    🔗 WRAPS: enigma_engine/tools/motion_tracking.py → MotionTracker
    """
