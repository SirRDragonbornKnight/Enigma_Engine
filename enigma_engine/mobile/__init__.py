"""
Mobile Package for Enigma AI Engine

This module re-exports from enigma_engine.comms.mobile_api for backwards compatibility.

The main mobile API implementation lives in enigma_engine.comms.mobile_api.

Usage:
    from enigma_engine.mobile import MobileAPI, run_mobile_api
    
    # Run API server
    run_mobile_api(host='0.0.0.0', port=5001)
    
    # Or create instance with custom settings
    api = MobileAPI(port=5001, model_name='enigma_engine')
    api.run()
