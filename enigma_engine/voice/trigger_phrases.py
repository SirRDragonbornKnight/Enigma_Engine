...
Allows users to wake the AI by saying phrases like "Hey Enigma AI Engine".
...
Usage:
    from enigma_engine.voice.trigger_phrases import TriggerPhraseDetector, SmartWakeWords
...
class TriggerConfig:
    ...
    def __post_init__(self):
        if self.phrases is None:
            self.phrases = ["hey ai tester", "ok ai tester", "enigma_engine"]
