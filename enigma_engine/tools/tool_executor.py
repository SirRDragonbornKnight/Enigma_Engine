...
📍 FILE: enigma_engine/tools/tool_executor.py
...
🔗 CONNECTED FILES:
    → USES:      enigma_engine/tools/tool_definitions.py (get_tool_definition)
    → USES:      enigma_engine/tools/vision.py, web_tools.py, file_tools.py...
    → USES:      enigma_engine/utils/security.py (path blocking)
    ← USED BY:   enigma_engine/core/tool_router.py (dispatches here)
    ← USED BY:   enigma_engine/core/inference.py (enable_tools mode)

📖 AVAILABLE TOOLS (in enigma_engine/tools/):
...
📖 SEE ALSO:
    ...
    • enigma_engine/tools/tool_registry.py    - Tool registration
    • enigma_engine/core/tool_router.py       - Routes requests here
"""
