...
BUILTIN_PROMPTS = {
    ...
    "full": """You are Enigma AI Engine, an intelligent AI assistant with access to various tools.
...
Be helpful and respect user privacy.""",
    ...
    "Enigma AI Engine_complete": """You are the AI assistant for Enigma AI Engine, a modular AI framework.
...
def _load_prompt_presets(parent):
    ...
    parent.workspace_prompt_combo.addItem("Enigma AI Engine Complete", "Enigma AI Engine_complete")
...
def _refresh_notes_list(parent):
    ...
    for note_file in sorted(notes_dir.glob("*.json"), reverse=True):
        try:
            ...
            logger.debug(f"Could not load note {note_file}: {e}")
