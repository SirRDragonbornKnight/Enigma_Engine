...
Features:
  ...
  - 3D models (GLB, GLTF, OBJ, FBX, VRM) - optional OpenGL rendering
...
Module Organization (Split for maintainability):
================================================
- avatar_rendering.py: OpenGL3DWidget (~900 lines)
- avatar_display.py: This file - overlays, widgets, helpers

Classes in this file:
- AvatarOverlayWindow - 2D desktop overlay
- DragBarWidget - Draggable title bar
- FloatingDragBar - Floating drag bar
- AvatarHitLayer - Click-through hit detection
- BoneHitRegion - Bone-specific click regions
- ResizeHandle - Corner resize handles
- BoneHitManager - Manages all hit regions
- Avatar3DOverlayWindow - 3D desktop overlay
- AvatarPreviewWidget - Main preview widget
"""
...
# Import OpenGL3DWidget from separated module
from .avatar_rendering import OpenGL3DWidget, HAS_TRIMESH, HAS_OPENGL

# Try importing optional 3D libraries (for local use in this file)
trimesh = None
np = None
...
MODEL_3D_EXTENSIONS = {'.glb', '.gltf', '.obj', '.fbx', '.dae', '.vrm'}
