...
# Config
NETWORK_CONFIG = Path.home() / ".enigma_engine" / "network_config.json"
...
class NetworkTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.scan_btn.setToolTip("Scan local network for other Enigma AI Engine instances")
            ...
            if ok and choice != "Cancel":
                if choice == "Download from remote":
                    ...
                    QMessageBox.information(self, "Model Sync", 
                        ...
                        f"from enigma_engine.comms import RemoteClient\n"
