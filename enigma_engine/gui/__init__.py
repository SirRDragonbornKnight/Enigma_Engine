"""
Enigma AI Engine GUI Package
==================

PyQt5-based graphical user interface for Enigma AI Engine.
...
Usage:
    ...
    # Or programmatically:
    from enigma_engine.gui import launch_gui, ForgeWindow
    launch_gui()
...
def launch_gui():
    """
    Launch the Enigma AI Engine GUI application.
