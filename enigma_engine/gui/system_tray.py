...
Features:
  ...
  - Voice activation support ("Hey Enigma AI Engine")
  - Background AI processing
  - Natural language command execution

Module Organization (3200+ lines):
==================================
Lines 71-165:    Utility Functions (get_current_model_name, kill_other_enigma_engine_instances)
...
def get_current_model_name() -> str:
    ...
    try:
        ...
        # Fallback to config
        model_name = CONFIG.get("default_model", "small_enigma_engine")
        return model_name
...
def kill_other_enigma_engine_instances() -> dict:
    """Kill other Enigma AI Engine processes to free up resources.
...
class HelpWindow(QWidget):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Enigma AI Engine - Help")
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("Enigma AI Engine Help")
...
class ForgeSystemTray(QObject):
    ...
    def _build_menu(self):
        ...
        close_btn.setToolTip("Exit Enigma AI Engine")
        close_btn.setStyleSheet("""
            QPushButton {
                background-color: transparent;
                border: none;
