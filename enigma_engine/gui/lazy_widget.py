...
Usage:
    from enigma_engine.gui.lazy_widget import LazyWidget
...
def create_lazy_image_tab(parent):
    ...
    return LazyWidget(
        parent,
        lambda p: _import_and_create('enigma_engine.gui.tabs.image_tab', 'create_image_tab', p),
...
def create_lazy_video_tab(parent):
    ...
    return LazyWidget(
        parent,
        lambda p: _import_and_create('enigma_engine.gui.tabs.video_tab', 'create_video_tab', p),
...
def create_lazy_threed_tab(parent):
    ...
    return LazyWidget(
        parent,
        lambda p: _import_and_create('enigma_engine.gui.tabs.threed_tab', 'create_threed_tab', p),
