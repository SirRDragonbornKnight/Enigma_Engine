...
USAGE:
    from enigma_engine.gui.widgets.quick_settings import QuickSettingsPanel
...
class QuickSettingsPanel(QWidget):
    ...
    def _load_settings(self):
        ...
        try:
            settings_file = Path.home() / ".enigma_engine" / "quick_settings.json"
...
class ResourceMonitor(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.cpu_label.setStyleSheet("color: #a6e3a1; font-size: 12px;")
        layout.addWidget(self.cpu_label)
        
        # RAM
        self.ram_label = QLabel("RAM: --MB")
        self.ram_label.setStyleSheet("color: #89b4fa; font-size: 12px;")
        layout.addWidget(self.ram_label)
        
        # VRAM (if GPU)
        self.vram_label = QLabel("")
        self.vram_label.setStyleSheet("color: #cba6f7; font-size: 12px;")
        layout.addWidget(self.vram_label)
        
        # Mode indicator
        self.mode_label = QLabel("Mode: Full")
        self.mode_label.setStyleSheet("color: #f9e2af; font-size: 12px;")
    ...
    def _update_stats(self):
        ...
        try:
            ...
            self.cpu_label.setStyleSheet(f"color: {cpu_color}; font-size: 12px;")
            ...
            self.ram_label.setStyleSheet(f"color: {ram_color}; font-size: 12px;")
        ...
        try:
            ...
            if torch.cuda.is_available():
                ...
                self.vram_label.setStyleSheet(f"color: {vram_color}; font-size: 12px;")
            else:
        ...
        try:
            ...
            if gm.active_game:
                ...
                self.mode_label.setStyleSheet("color: #f38ba8; font-size: 12px;")
            else:
