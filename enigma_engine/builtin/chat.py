...
class BuiltinChat:
    ...
    def __init__(self):
        ...
        self.patterns = [
            ...
            # Enigma AI Engine specific
            (r'\b(forge|Enigma AI Engine)\b', [
                "Enigma AI Engine is a modular AI framework! You can train models, generate images, "
                "create code, and more. Check the tabs for different features!",
                "I'm part of Enigma AI Engine! This is the built-in fallback chat when the full AI model isn't loaded.",
            ]),
