...
Contains the core components of the Enigma AI Engine AI framework:
...
Use `from enigma_engine.core import create_model` - it only imports torch when called.
"""
...
# Trainer AI (Meta-AI for training data generation and curation)
try:
...
# HuggingFace exporter (for uploading Enigma AI Engine models to HF Hub)
...
__all__ = [
    ...
    # Trainer AI (Meta-AI for training data)
    "TrainerAI",
    "get_trainer_ai",
    "POSITION_CONFIGS",
    "DataQualityScore",
    ...
    # HuggingFace export (upload Enigma AI Engine models to Hub)
    "HuggingFaceExporter",
    "export_model_to_hub",
