...
Usage:
    from enigma_engine.core.prompt_manager import PromptManager, get_prompt_manager
...
DEFAULT_BASE_PROMPT = """You are Forge, an AI assistant created with Enigma AI Engine.
...
class PromptManager:
    """
    Centralized prompt management for all Enigma AI Engine modules.
