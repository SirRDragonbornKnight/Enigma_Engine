...
def _ensure_ollama_imports() -> None:
    """Load torch and numpy on first call."""
    global _ollama_imports_checked, HAS_TORCH, HAS_NUMPY, torch, np
    if _ollama_imports_checked:
        return
    _ollama_imports_checked = True
    try:
