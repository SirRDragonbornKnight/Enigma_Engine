...
Usage:
    from ai_tester.voice import speak, listen, set_voice
    ...
    # Create custom voice
    from ai_tester.voice import VoiceProfile, VoiceEngine
    ...
    # AI voice discovery
    from ai_tester.voice import AIVoiceIdentity, discover_voice
