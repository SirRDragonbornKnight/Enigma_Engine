"""
Mobile Package for AI Tester

This module re-exports from ai_tester.comms.mobile_api for backwards compatibility.

The main mobile API implementation lives in enigma.comms.mobile_api.

Usage:
    from ai_tester.mobile import MobileAPI, run_mobile_api
    
    # Run API server
    run_mobile_api(host='0.0.0.0', port=5001)
    
    # Or create instance with custom settings
    api = MobileAPI(port=5001, model_name='ai_tester')
    api.run()
