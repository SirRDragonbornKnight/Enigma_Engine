...
Usage:
    from ai_tester.mobile.api import mobile_app
...
def get_engine():
    ...
    if _engine is None:
        try:
            ...
            default_model = CONFIG.get("default_model", "ai_tester")
...
if FLASK_AVAILABLE:
    ...
    def mobile_chat():
        ...
        try:
            ...
            return jsonify({
                'response': response,
                'model': CONFIG.get('default_model', 'ai_tester'),
    ...
    def list_models():
        ...
        {
            "models": [
                {"name": "ai_tester", "size": "small", "loaded": true},
                ...
            ]
        }
        """
    ...
    def mobile_status():
        ...
        return jsonify({
            ...
            'model_name': CONFIG.get('default_model', 'ai_tester'),
            'version': '1.0',
            'features': features,
            'timestamp': datetime.now().isoformat()
        })
