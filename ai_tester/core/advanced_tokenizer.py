...
This is the AI Tester's custom tokenizer - not a GPT clone.
"""
import json
import random
import re
...
class AITesterTokenizer:
    ...
    def get_info() -> Dict[str, Any]:
        ...
        """
        return {
            'name': 'AITesterTokenizer',
            'version': '2.1.0',
            'engine': 'AI Tester',
            'type': 'Byte-level BPE',
            'description': "AI Tester's native tokenizer with unique [E:token] format",
            'features': [
    ...
    def __repr__(self) -> str:
        ...
        return f"AITesterTokenizer(vocab_size={self.vocab_size}, merges={len(self.bpe_ranks)})"
    
    def __str__(self) -> str:
        """Return a human-readable string."""
        return f"AITesterTokenizer v2.1.0 - Vocab: {self.vocab_size:,} tokens"
