...
LEGACY_MODEL = MODELS_DIR / "tiny_ai_tester.pth"
...
class AITesterEngine:
    ...
    def _load_model(
        ...
        if model_file and model_file.exists():
            ...
            raise FileNotFoundError(
                ...
                f"  3. Or specify model_path when creating AITesterEngine"
            )
    ...
    def _infer_model_size(self, state_dict: Dict) -> str:
        ...
        # Match to preset - MODEL_PRESETS values are AITesterConfig with 'dim' attribute
    ...
    def _log_init_info(self):
        ...
        print(system_msg(f"AITesterEngine initialized on {self.device}"))
...
def generate(
    ...
    **kwargs
    ...
    Returns:
        Generated text
    """
    engine = AITesterEngine(model_path=model_path)
...
def load_engine(
    ...
    Returns:
        AITesterEngine instance
    """
    return AITesterEngine(model_path=model_path, device=device)
