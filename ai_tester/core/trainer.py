...
USAGE:
    from ai_tester.core.trainer import AITesterTrainer
...
from .model import Enigma, TinyAITester  # TinyAITester is backwards compat alias
...
class AITesterTrainer:
    ...
    def __init__(
        self,
        model: Union[Enigma, TinyAITester],
        model_name: str,
        registry: ModelRegistry,
...
if __name__ == "__main__":
    # Example usage
    print("AITesterTrainer - Advanced Training System")
    print("Use train_model_by_name() or create an AITesterTrainer instance")
