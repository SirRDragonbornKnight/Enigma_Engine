...
Usage:
    from ai_tester.core.offloading import OffloadedModel, get_device_map
...
def get_device_map(
    ...
    try:
        ...
        max_memory = get_balanced_memory(
            ...
            no_split_module_classes=["EnigmaLayer", "TransformerBlock"]  # Don't split these
        )
        ...
        device_map = infer_auto_device_map(
            ...
            no_split_module_classes=["EnigmaLayer", "TransformerBlock"]
        )
