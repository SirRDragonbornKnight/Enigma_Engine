...
Usage:
    from ai_tester.core.huggingface_loader import HuggingFaceModel
...
class HuggingFaceEngine:
    """
    High-level inference engine compatible with AITesterEngine interface.
    
    Drop-in replacement for AITesterEngine using HuggingFace models.
    """
