...
from .model import Enigma, AITesterConfig, MODEL_PRESETS
...
Q: Who made you?
A: I was created using the AI Tester.
...
""")
        ...
        self.registry["models"][name] = {
            "path": str(model_dir),
            "size": size,
            "source": "ai_tester",  # Mark as Enigma model (not HuggingFace)
    ...
    def load_model(
        ...
        # Create AITesterConfig from saved config (handles legacy parameter names)
        model_config = AITesterConfig.from_dict(config)
