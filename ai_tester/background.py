"""
Enigma Background Service - Run AI without the full GUI.

This starts Enigma in the system tray with quick command access.
...
def main():
    """Run Enigma in background mode (system tray only)."""
    try:
    ...
    try:
        ...
        tray.show_notification(
            "Enigma Background Service",
            "Enigma is running in the background.\n"
            "Click tray icon or press Ctrl+Space for commands."
        )
        
        print("Enigma running in background. Press Ctrl+C to exit.")
