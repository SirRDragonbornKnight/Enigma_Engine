...
class SetupWizard(QWizard):
    ...
    def initializePage(self, page_id):
        ...
        if page_id == 3:  # Confirm page
            ...
            # MODEL_PRESETS contains AITesterConfig objects, not dicts
...
class ModelManagerDialog(QDialog):
    ...
    def _refresh_list(self):
        ...
        for name, info in sorted(models.items()):
            ...
            if model_path.exists():
                ...
                size = info.get("size", "?")
                source = info.get("source", "ai_tester")
    ...
    def _on_select_model(self, item):
        ...
        try:
            ...
            source = reg_info.get('source', 'ai_tester')
...
class EnhancedMainWindow(QMainWindow):
    ...
    def _show_model_selector_deferred(self):
        ...
        self.setWindowTitle(f"AI Tester - Loading {self.current_model_name}...")
    ...
    def _load_current_model(self):
        ...
        try:
            ...
            self.setWindowTitle(f"AI Tester - {self.current_model_name} {model_type}")
    ...
    def _on_send(self):
        ...
        if is_hf:
            ...
            system_prompt = (
                "You are an AI assistant running in the AI Tester GUI. "
...
"""
    ...
    def _on_open_model(self):
        ...
        if dialog.exec_() == QDialog.Accepted:
            ...
            if selected:
                ...
                self.setWindowTitle(f"AI Tester - {self.current_model_name}")
    ...
    def _on_start_training(self):
        ...
        try:
            from ..core.trainer import AITesterTrainer
            
            model, config = self.registry.load_model(self.current_model_name)
            
            trainer = AITesterTrainer(
                model=model,
...
What would you like to do?""")
                        ...
                        if clicked == minichat_btn:
                            ...
                            from .system_tray import kill_other_ai_tester_instances
                            kill_other_ai_tester_instances()
                            event.accept()
                            window._save_gui_settings()
                            _system_tray.tray_icon.hide()
                            QApplication.quit()
